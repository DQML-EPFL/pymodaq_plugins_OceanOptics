...
from pymodaq_plugins_OceanOptics.hardware.oceandirect.sdk_properties import oceandirect_dll
from pymodaq_plugins_OceanOptics.hardware.oceandirect.od_logger import od_logger
